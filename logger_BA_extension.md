...
1. Speicherung der MQTT-Nachrichten in der bestehenden CSV-Logdatei.
2. Direkte Weitergabe der Nachrichten an `live_to_mariadb.py` zur Speicherung in MariaDB.
